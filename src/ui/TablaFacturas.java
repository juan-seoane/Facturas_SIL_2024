...
public boolean actualizarModelo(Vector facturas, int sel){
	...
	tablafacturas.setModel(modelo);
        ...
        {
            TableColumn columna = tablafacturas.getColumn(Config.getConfig().getNombresColumnas().get(i));
            if (Config.getConfig().getAnchoColumnas().get(i)!=null)
            {
                columna.setMaxWidth((int)Config.getConfig().getAnchoColumnas().get(i));
                columna.setMinWidth((int)Config.getConfig().getAnchoColumnas().get(i));
            }
        }
